...
def run_mcx(ua, us, g=0.85, n=1.370, distances = [15, 20, 25, 30], tend =1e-08, devf = 10000, nphoton = 1e8):
...
# get the fft, freqs. 
def mcx_fft(ua, us, g=0.85, n=1.370, distance =  [15, 20, 25, 30], tend =1e-08, devf = 10000, nphoton = 1e8):
